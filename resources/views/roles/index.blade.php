                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($roles as $role)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{\Carbon\Carbon::parse($role->created_at)->format('d M,Y') }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <a href="{{ route('roles.show', $role->id) }}" class="text-blue-600 hover:text-blue-900">View</a>
                                        <a href="{{ route('roles.edit', $role->id) }}" class="text-green-600 hover:text-green-900 ml-4">Edit</a>
